...
export class TableStudent implements TableInterface {
    ...
    createTable(connection: Connection) {
        let createTable: string = `create table ${this.tableName} (id BIGINT PRIMARY KEY AUTO_INCREMENT, first_name VARCHAR(50), last_name VARCHAR(50), career VARCHAR(50), image_url blob)`;
